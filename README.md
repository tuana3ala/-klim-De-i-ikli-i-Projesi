# EcoAI İklim Değişikliği Sohhet Botu
**Proje amacı: 
İnsanları iklim değişikliği hakkında bilinçlendirmek ve bilgilendirmek.**
## İçerisindeki Özellikler
...
* Kullanıcının cevabı doğru olduğunda kullanıcıya sanal puanlar verilir ve böylece bu özelliğin sürerliliği sağlanır.
### ♻️ Eylem Çağrıları ve İpuçları ♻️
* Bot, kullanıcılara günlük yaşamlarında uygulayabilecekleri basit ve etkili çevre dostu ipuçlar verir.
...
### 📅 Günlük Görevler 📅
* Bot, kullanıcıya iklim dostu bir görev verir. Bu görevleri bot her gün farklı bir görev ataması yapıcak şeklinde programlamlanmıştır.
